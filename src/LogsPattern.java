...
public class LogsPattern {
    ...
    public LogsPattern()
    {
        ...
        OnePattern data = new OnePattern("data", 22);
        //
        ...
        OnePattern thread = new OnePattern("thread", 45);
        ...
        OnePattern logger = new OnePattern("logger", 30);
        ...
        OnePattern message = new OnePattern("message", 35);
        //message.AddRegular("(?!\\]$)(?!\\[$)(?!\\)$)(?!\\($)(.*)");
        message.AddRegular(".*");
